...
func DrawSegment(screen *ebiten.Image, x, y, rInner, rOuter int, angleStart, angleEnd float64, clr color.Color) {
	...
	// Цвет бордера — светло‑серый, чтобы сегменты чётко отделялись друг от друга,
	// но не выглядели слишком контрастно на тёмном фоне.
	borderColor := color.RGBA{189, 189, 189, 255} // #BDBDBD
